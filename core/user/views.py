...
class ActivateUserUpdateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    model = User
   # form_class = UserForm
    ...
    def activar(request, id):
        if request.method == 'GET':
            ...
            return HttpResponse("ERROR AL GRUADAR")
...
class DesactivarUserUpdateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    model = User
   # form_class = UserForm
    template_name = 'user/create.html'
    success_url = reverse_lazy('user:user_list')
